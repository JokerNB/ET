...
namespace ET.Client
{
    public static partial class FUIComponentSystem
    {
        ...
        public static void ClosePanel<P1>(this FUIComponent self, PanelInfo panelInfo, P1 p1)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelInfo);
        ...
        public static void ClosePanel<P1, P2>(this FUIComponent self, PanelInfo panelInfo, P1 p1, P2 p2)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelInfo);
        ...
        public static void ClosePanel<P1, P2, P3>(this FUIComponent self, PanelInfo panelInfo, P1 p1, P2 p2, P3 p3)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelInfo);
        ...
        public static void ClosePanel<P1, P2, P3, P4>(this FUIComponent self, PanelInfo panelInfo, P1 p1, P2 p2, P3 p3, P4 p4)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelInfo);
        ...
        public static void ClosePanel<P1, P2, P3, P4, P5>(this FUIComponent self, PanelInfo panelInfo, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5)
        {
            FUIEntity fuiEntity = self.GetFirstFUIEntityByPanelId(panelInfo);
