namespace ET.Client
{
    public static partial class SceneChangeHelper
    {
        ...
        public static async ETTask SceneChangeTo(Scene root, string sceneName, long sceneInstanceId)
        {
            ...
            UnitComponent_Client unitComponent = currentScene.AddComponent<UnitComponent_Client>();
            ...
            Unit_Client unit = UnitFactory.Create(currentScene, m2CCreateMyUnit.Unit);
