	...
	public static PolyNav2D current{
		get
		{
			if (_current == null || !Application.isPlaying)
				_current = FindFirstObjectByType<PolyNav2D>();/* FindObjectOfType(typeof(PolyNav2D)) as PolyNav2D;*/
...
////////////////////////////////////////
	...
	public static void CreatePolyNav2D (){
		if (FindFirstObjectByType<PolyNav2D>()/*FindObjectOfType(typeof(PolyNav2D))*/ == null){
